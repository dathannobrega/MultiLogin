...
function u(url) {
    if (n) {
        var shortSessionIdentifier = n.slice(-4); // Usar os últimos quatro caracteres do identificador da sessão
        if (url.substr(0, shortSessionIdentifier.length + 2) != "[" + shortSessionIdentifier + "]") {
            document.title = "[" + shortSessionIdentifier + "] " + url;
        }
    } else {
        document.title = url;
    }
